...
export const CHARACTERS = {
  ...
  gera: {
    ...
    speedMul: 1.0, ultCost: 7,
    desc: 'Разрушитель тумана. Жёсткий контр-пик смокерам: видит сквозь вражеский дым и развеивает его.',
    abilities: {
...
// Пассивки агентов (Эпоха 15) — коротко, для UI/справки; логика в server.js/клиенте
export const PASSIVES = {
  artemiy: 'Не горит в своём огне',
  max: 'Бесшумный бег и +скорость',
  denis: 'Медленный саморег HP',
  sova: 'Видит иконки брошенного оружия сквозь стены',
  sanek: 'Шаги врагов видны на его миникарте',
  ira: 'Её убийство создаёт хил-зону у трупа врага для союзников',
  vova: 'Хозяин тумана: в своих дымах видит силуэты союзников',
  fafik: 'Батина закалка: контузии/ослепления на нём короче ~30%',
  koniliy: 'Разгон: 2 с бега прямо без стрельбы дают +скорость',
  gera: 'Ясный глаз: вражеские дымы для неё полупрозрачны — видит сквозь них силуэты',
};
